// Mirror of backend/src/lib/admin/permissions.ts. The browser cannot
// trust these — server still enforces. Used here only to hide UI
// affordances the caller could not use anyway.
...
export function has(permissions: string[], p: Permission): boolean {
